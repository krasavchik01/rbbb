...
> Цель: убрать legacy-мусор и сфокусировать HUB на сильном рабочем ядре: проекты, роли, задачи, часы, утверждения, бонусы, прозрачность.

## 1. Продуктовое решение

Владелец продукта хочет, чтобы HUB перестал быть сборником старых экспериментов.
