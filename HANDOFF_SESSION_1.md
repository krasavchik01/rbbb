...
Документ фиксирует фактическое состояние проекта SUITE-A / RBBB по текущей сессии, приложенному pasted-text и локальной проверке репозитория. Код, схемы и конфигурация не исправлялись в рамках подготовки этого handoff; создан только этот файл.
...
Цель проекта - довести SUITE-A / RBBB до простой рабочей системы управления проектами аудиторской/консалтинговой группы, построенной вокруг одной основной таблицы проектов, которая соответствует управленческому "Своду" CEO.
