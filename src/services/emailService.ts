    ...
    const message: EmailMessage = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <p>Проверьте детали проекта в системе HUB.</p>
          <div style="margin-top: 20px; padding: 15px; background: #f3f4f6; border-radius: 8px;">
            <p style="margin: 0; color: #6b7280;">Это автоматическое уведомление от HUB</p>
          </div>
        </div>
      `
    };
    ...
    const message: EmailMessage = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <p>Проверьте детали задачи в системе HUB.</p>
          <div style="margin-top: 20px; padding: 15px; background: #f3f4f6; border-radius: 8px;">
            <p style="margin: 0; color: #6b7280;">Это автоматическое уведомление от HUB</p>
          </div>
        </div>
